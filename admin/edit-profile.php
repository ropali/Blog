 ...
 <?php 
    ...
    if(isset($_GET['edit'])){
        ...
        if(mysql_num_rows($edit_run) > 0){
            ...
            if($session_username == $edit_username){
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <h1><i class="fa fa-pencil-square" aria-hidden="true"></i>
                    Edit Profile <small>Edit Profile Details</small>
                </h1>
                <hr>
                <ol class="breadcrumb">
                ...
                <?php
                    if(isset($_POST['submit'])){
                        ...
                        if(empty($fname) or empty($lname) or empty($email) or empty($password) or empty($details) or empty($image)){
                            ...
                            $update_query = "UPDATE `users` SET `first_name` = '$fname', `last_name` = '$lname', `email` = '$email', `image` = '$image', `password` = '$insert_password', `details` = '$details' WHERE `users`.`id` = $edit_id";
